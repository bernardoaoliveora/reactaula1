...
export default function Card(props) {
    ...
    */}
                ...
                <div class="e-card playing">
                    ...
                    <div class="infotop"> <div className="color">{props.icone}</div>
            ...
            20.3676C11.9347 20.5316 11.1396 20.4203 10.4684 20.0413H10.4676Z"></path></svg>*/}
                        ...
                        <div className="name">{props.texto}</div>
                        <br />
                        <div className="descricao">{props.descricao}</div>
                        <div className="click" onClick={props.onClick}>
                            <button>Tocar</button>
                        </div>
                    </div>
                </div>
...
// export default Card()  deixa Card() como uma função padrão.